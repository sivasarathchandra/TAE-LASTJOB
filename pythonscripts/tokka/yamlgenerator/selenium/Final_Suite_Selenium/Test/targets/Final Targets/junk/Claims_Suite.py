...
from tests.RCR_VR_HA_FE_ConfigTool_Claims import ClaimsFE
...
if __name__ == '__main__':
    ...
    tabList = inputs['claimsTabList']
    adjustmentList = inputs['claimsList']
    ...
    if domain == 'staging':
        ...
        for incr in adjustmentList:
            ...
            suite.addTest(ParametrizedTestCase.parametrize(ClaimsFE, driverParam=browser, urlParam=adjustmentsUrl, facility_name=facility_name, urlListParam = tabList))
    elif domain == 'dev':
