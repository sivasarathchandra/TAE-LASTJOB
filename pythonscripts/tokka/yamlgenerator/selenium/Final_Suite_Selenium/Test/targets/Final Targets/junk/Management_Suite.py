...
from tests.RCR_VR_HA_FE_ConfigTool_Management import ManagementFE
...
if __name__ == '__main__':
    ...
    tabList = inputs['managementTableList']
    adjustmentList = inputs['managementList']
    ...
    if domain == 'staging':
        ...
        for incr in adjustmentList:
            ...
            suite.addTest(ParametrizedTestCase.parametrize(ManagementFE, driverParam=browser, urlParam=adjustmentsUrl, facility_name=facility_name, urlListParam = tabList))
    elif domain == 'dev':
