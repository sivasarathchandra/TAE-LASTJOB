...
class TestAgeCategoriesFE(ParametrizedTestCase):
    ...
    def data_extractor(self):
        with open('"'+WORKSPACE+'"'+"resource/Age_category_Input.json","r")as readfile:
    ...
    def test_step4_duplicate_age_category(self):
        ...
        loggingFE.logger.info("The test case for the age category duplicate is passed!!!")
        self.driver.get(self.url)
        self.driver.implicitly_wait(30)
        self.driver.quit()
    ...
    def test_step3_age_category_required(self):
        ...
        loggingFE.logger.info("The test case for the no age category is passed!!!")
        self.driver.get(self.url)
        self.driver.implicitly_wait(30)
        self.driver.quit()
    ...
    def test_step6_overlap_age(self):
        ...
        loggingFE.logger.info("The test case for the overlap age category is passed!!!")
        self.driver.get(self.url)
        self.driver.implicitly_wait(30)
        self.driver.quit()
    ...
    def test_step5_age_gap(self):
        ...
        loggingFE.logger.info("The test case for the age gap category is passed!!!")
        self.driver.get(self.url)
        self.driver.implicitly_wait(30)
        self.driver.quit()
    ...
    def test_step7_begin_age_less_than_end_age(self):
        ...
        loggingFE.logger.info("The test case for the begin age greater than end age is passed!!!")
        self.driver.get(self.url)
        self.driver.implicitly_wait(30)
        self.driver.quit()
    ...
    def test_step2_negative_values_save(self):
        ...
        self.actions = ActionChains(self.driver)
        self.actions.click(self.save_page).perform()
        loggingFE.logger.info("Deleted and entered a new row")
        ...
        for self.increment in self.keys_validation:
            ...
            validate = validate + 1
        loggingFE.logger.info("Data is validated after the save!!!")
        self.driver.implicitly_wait(30)
        self.driver.close()
