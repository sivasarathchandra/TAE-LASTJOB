...
class login():
    ...
    def login_staging():
        ...
        return browser
    def login_15STP():
        loggingFE.logger.info("logging into 15stp domain")
        chrome_options = Options()
        chrome_options.add_argument("--headless")
        chrome_options.add_argument("--window-size=800x600")
        browser = webdriver.Chrome(chrome_options=chrome_options)
        browser.get("https://sl044390:sl044390@associates.sandboxcerner.com/accounts/login//auto")
        browser.implicitly_wait(10)
        search_field_UN = browser.find_element_by_xpath('//*[@id="authUsername"]')
        search_field_UN.clear()
        search_field_UN.send_keys('SD056953')
        search_field_PWD = browser.find_element_by_xpath('//*[@id="authPassword"]')
