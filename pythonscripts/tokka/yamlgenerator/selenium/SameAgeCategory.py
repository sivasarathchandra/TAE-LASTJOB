...
with open("SameAgeCategory.csv","r") as read_file:
    for line in read_file:
        if re.match(r"^\d+.*$", line):
            ...
            break
driver.implicitly_wait(30)
eror = driver.find_element_by_xpath('//*[@id="form-update"]/div/div/div/div[2]/article/div/div/table/tbody/tr[10]/td[1]/div')
driver.implicitly_wait(30)
error_msg = eror.get_attribute('title')
print(error_msg)