...
old_line = driver.find_element_by_xpath('/html/body/div/div[2]/main/div/div[2]/div/form/div/div/div/div[2]/article/div/div/table/tbody/tr[9]/td[5]/input')
old_line.clear()
old_line.send_keys(366)
...
with open("NoAgeCategory.csv","r") as read_file:
...
driver.save_screenshot('No_Age_Category.png')
print(error_msg)
driver.get("https://adventisthealthsystem.analytics.staginghealtheintent.com/explore/revenue_cycle/config/config/age_category")
driver.close()